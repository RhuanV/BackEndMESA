...
class UserRepository:
    def __init__(self) -> None:
        # At the production stage, use enviroment variables (.env)
    ...
    def obtain_user_from_username(self, username: str) -> dict | None:
        """Searches for the user with a given username and return his/her hash, role e other necessary authentication data."""
        with psycopg2.connect(self.conn_params) as conn:
            with conn.cursor(cursor_factory=RealDictCursor) as cur:
