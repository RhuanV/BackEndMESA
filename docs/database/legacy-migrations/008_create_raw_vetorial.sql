-- =============================================================================
-- Additional tables for government data and OpenStreetMap (OSM)
-- Follows the naming convention of the mesa_a schema
-- =============================================================================

-- Create the MESA-A schema
CREATE SCHEMA IF NOT EXISTS mesa_a;


-- =============================================================================
-- Theme: Territorial units
-- =============================================================================


-- Table for state boundaries (IBGE)
...
-- Table for municipality boundaries (IBGE)
...
-- =============================================================================
-- Theme: Hydrography, fauna, and flora
-- =============================================================================
...
-- Table to store airport polygons and lines extracted from OpenStreetMap (OSM).
...
-- Table for Federal Highways (Ministry of Transport)
...
-- Table for Railways (Ministry of Transport)
...
-- Table for Waterways (Ministry of Transport)
...
-- Table for Ports (Ministry of Transport)
...
-- Table for Federal Highways (OpenStreetMap)
...
-- Table for State Highways (OpenStreetMap)
...
-- Table for Railways (OpenStreetMap)
...
-- Table for Waterways (OpenStreetMap)
...
-- Table for Transmission Lines (OpenStreetMap)
...
-- Table for the Information Layer: Pipelines (OpenStreetMap)
...
-- Table for the Information Layer: Conservation Unit 
...
-- Table for the Information Layer: Rural Properties (SICAR)
...
-- Theme: Territorial Units
-- Table for the Information Layer: Indigenous Land (FUNAI) — Airflow DAG
...
-- Theme: Territorial Units
-- Table for the Information Layer: Caves (ICMBio) — Airflow DAG
...
-- Theme: Hydrography, Fauna, and Flora
-- Table for the Information Layer: ANA Rivers (Otto-coded Hydrographic Base) — Airflow DAG
...
-- Theme: Infrastructure
-- Table for the Information Layer: Airports (Ministry of Infrastructure) — Airflow DAG
...
-- Theme: Infrastructure
-- Table for the Information Layer: Aerodromes (ANA) — Airflow DAG
...
-- Table for the Information Layer: Transmission Lines (MMA/ANEEL) — Airflow DAG
