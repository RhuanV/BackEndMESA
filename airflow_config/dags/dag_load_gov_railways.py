"""
Loads the rail network (Ministry of Transport) into the mesa_a.vetor_gov_ferrovias table.
"""
import os
import zipfile
import logging
...
def extract_railways(**kwargs) -> str:
    ...
    response = government_get(RAILWAY_BRAZIL_URL, stream=True, headers=headers)
