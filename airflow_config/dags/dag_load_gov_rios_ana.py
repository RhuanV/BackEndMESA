"""
Loads the ANA/SNIRH hydrographic network (BHO) into the mesa_a.vetor_gov_rios_ana table.
"""
import os
import zipfile
import logging
...
def extract_rios_ana(**kwargs) -> str:
    ...
    response = government_get(RIOS_ANA_URL, stream=True, headers=headers)
...
def transform_rios_ana(**kwargs) -> str:
    ...
    # Ensure geometries are in SIRGAS 2000 (EPSG:4674); the source is usually SAD69 (EPSG:4291)
