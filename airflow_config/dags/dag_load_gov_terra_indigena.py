"""
Loads indigenous lands (FUNAI GeoServer) into the mesa_a.vetor_gov_terra_indigena table.
"""
import os
import zipfile
import logging
...
def extract_terra_indigena(**kwargs) -> str:
    ...
    response = government_get(TERRA_INDIGENA_URL, stream=True, headers=headers)
