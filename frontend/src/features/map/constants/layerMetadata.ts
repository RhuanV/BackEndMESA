...
export const LAYER_REGISTRY: readonly LayerMetadata[] = [
  ...
  // === Fase 4 — fontes vetoriais adicionais (BDG) ===
  // Servidas pelas views de resolução (migração 0027) e ingeridas pelas DAGs
  // load_incra_*/load_mma_*/load_cprm_*/load_ibge_biomas (ou pelo seed demo).
  {
    id: 'ibge-biomas',
    name: 'Biomas',
    group: 'analysis',
    ...
    epsg: 'EPSG:4674 (SIRGAS 2000)',
    description: 'Biomas brasileiros (IBGE).',
    type: 'vector',
    defaultVisible: false,
    backendName: 'ibge_biomas',
    catalogKey: 'diverso__ibge',
    paint: {
      maplibreType: 'fill',
      paint: { 'fill-color': '#65a30d', 'fill-opacity': 0.25, 'fill-outline-color': '#3f6212' },
    },
  },
  {
    id: 'incra-quilombolas',
    name: 'Terras Quilombolas',
    group: 'exclusion',
    source: 'INCRA — Áreas de Quilombolas',
    lastUpdate: '2025-01-01',
    epsg: 'EPSG:4674 (SIRGAS 2000)',
    description: 'Territórios quilombolas certificados (INCRA). Área de exclusão.',
    type: 'vector',
    defaultVisible: false,
    backendName: 'incra_quilombolas',
    catalogKey: 'terras_quilombolas__incra',
    paint: {
      maplibreType: 'fill',
      paint: { 'fill-color': '#b45309', 'fill-opacity': 0.35, 'fill-outline-color': '#78350f' },
    },
  },
  {
    id: 'incra-assentamentos',
    name: 'Assentamentos',
    group: 'base',
    source: 'INCRA — Assentamentos',
    lastUpdate: '2025-01-01',
    epsg: 'EPSG:4674 (SIRGAS 2000)',
    description: 'Assentamentos de reforma agrária (INCRA).',
    type: 'vector',
    defaultVisible: false,
    backendName: 'incra_assentamentos',
    catalogKey: 'assentamentos__incra',
    paint: {
      maplibreType: 'fill',
      paint: { 'fill-color': '#ca8a04', 'fill-opacity': 0.3, 'fill-outline-color': '#854d0e' },
    },
  },
  {
    id: 'mma-florestas-publicas',
    name: 'Florestas Públicas',
    group: 'exclusion',
    source: 'MMA — Florestas Públicas',
    lastUpdate: '2024-01-01',
    epsg: 'EPSG:4674 (SIRGAS 2000)',
    description: 'Cadastro Nacional de Florestas Públicas (MMA). Área de exclusão.',
    type: 'vector',
    defaultVisible: false,
    backendName: 'mma_florestas_publicas',
    catalogKey: 'florestas_publicas__min_meio_ambiente',
    paint: {
      maplibreType: 'fill',
      paint: { 'fill-color': '#166534', 'fill-opacity': 0.3, 'fill-outline-color': '#14532d' },
    },
  },
  {
    id: 'cprm-geodiversidade',
    name: 'Geodiversidade',
    group: 'analysis',
    source: 'CPRM — Serviço Geológico do Brasil',
    lastUpdate: '2023-01-01',
    epsg: 'EPSG:4674 (SIRGAS 2000)',
    description: 'Unidades de geodiversidade (CPRM).',
    type: 'vector',
    defaultVisible: false,
    backendName: 'cprm_geodiversidade',
    catalogKey: 'diverso__cprm',
    paint: {
      maplibreType: 'fill',
      paint: { 'fill-color': '#7c3aed', 'fill-opacity': 0.25, 'fill-outline-color': '#5b21b6' },
    },
  },
] as const;
