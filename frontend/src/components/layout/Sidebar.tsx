...
const navItems: NavItem[] = [
  // === Shared ===
  {
    to: '/dashboard/map',
    label: 'Mapa',
    allowedRoles: ['coordenador', 'gestor', 'supervisor', 'operador', 'administrador', 'desenvolvedor'],
    icon: (
  ...
  // === Analyst ===
  {
    ...
    label: 'Análise MESA',
    section: 'Operação',
    allowedRoles: ['coordenador', 'supervisor', 'operador', 'desenvolvedor'],
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} aria-hidden="true">
  ...
  },
  {
    ...
    section: 'Operação',
    allowedRoles: ['coordenador', 'gestor', 'operador', 'desenvolvedor'],
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} aria-hidden="true">
  ...
  },
  {
    ...
    label: 'Resultados',
    section: 'Operação',
    allowedRoles: ['coordenador', 'gestor', 'supervisor', 'operador', 'desenvolvedor'],
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} aria-hidden="true">
  ...
  // === Admin ===
  {
    ...
    allowedRoles: ['coordenador', 'gestor', 'supervisor', 'desenvolvedor'],
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} aria-hidden="true">
  ...
  },
  {
    ...
    section: 'Administração',
    allowedRoles: ['coordenador', 'administrador', 'desenvolvedor'],
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} aria-hidden="true">
  ...
  // === Dev ===
  {
    ...
    allowedRoles: ['administrador', 'desenvolvedor'],
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} aria-hidden="true">
